    ...
    return (
      <>
        <motion.div
          ...
          className={cn(
            "absolute top-20 left-0 m-auto h-14 w-px rounded-full bg-gradient-to-t from-amber-500 via-amber-200 to-transparent",
    ...
    <div {...props} className={cn("absolute z-50 h-2 w-2", props.className)}>
      ...
      {spans.map((span) => (
        <motion.span
          ...
          className="absolute h-1 w-1 rounded-full bg-gradient-to-b from-amber-100 to-amber-300"
        />
      ))}
    </div>
  );
